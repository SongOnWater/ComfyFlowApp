...
from modules import get_comfy_client, get_group_app_model, get_workspace_model, check_comfyui_alive
...
def preview_group_app_ui(app):
    with page.stylable_button_container():
        ...
        header_row.title(f"💡Preview {app.name}")
    ...
    with st.container():
        ...
        for group in groups:
            with st.container():
                comfyflow = Comfyflow(comfy_client=comfy_client, app=group)
                comfyflow.create_ui()
